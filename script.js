...
const CERTS = [
  ...
  { acronym: 'CPTS',  name: 'Red Team Operator Program', status: 'in-progress', image: 'badges/CPTS.png',
    url: '' },
...
function badgeFallbackSVG(acronym) {
  return `
<svg viewBox="0 0 90 90" width="72" height="72" xmlns="http://www.w3.org/2000/svg">
